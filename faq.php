  ...
  <TR>
    ...
    <TD width="90%">
      ...
      <OL>
        ...
        <LI>Please, no cursing in the beacons or the forums. 
...
<TABLE cellSpacing=0 width="100%" border=0>
  ...
  <TR>
    ...
    <TD width="5%">&nbsp;</TD></TR></TBODY></TABLE><BR><A name=misc></A>
<TABLE cellSpacing=0 width="100%" border=0>
  <TBODY>
  <TR>
  ...
  <TR>
    ...
    <TD width="90%">
      ...
      and you have your answer.<BR><BR>
      <TABLE width="100%">
        <TBODY>
        <TR>
  ...
  <TR>
    ...
    <TD width="90%">
      ...
      For example, upgrading from 0 to 1 costs 1,000 credits.<BR><BR>
      <TABLE width="100%">
        <TBODY>
        <TR>
          <TD align=middle width="20%">
