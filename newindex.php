...
// New database driven language entries - these are only for header and footer, until we migrate those over to use the new translation object
load_languages($db, $lang, array('footer', 'news'), $langvars, $db_logging);
