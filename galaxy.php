<?php
	...
	echo "<tr><td style='background-color:#111111; text-align:center; border:#555555 1px solid; color:#FFFFFF; font-size:26px; padding:4px;' colspan='52'>Blacknova Traders Galaxy Map</td></tr>\n";
	...
	echo "<tr><td style='background-color:#111111; text-align:left; border:#555555 1px solid; color:#FFFFFF; font-size:12px; padding:4px;' colspan='52'>Galaxy Map</td></tr>\n";
	echo "</table>\n";
