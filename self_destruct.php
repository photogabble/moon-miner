...
load_languages ($db, $lang, array ('self_destruct', 'ranking', 'common', 'global_includes', 'global_funcs', 'news', 'footer'), $langvars);
...
elseif ($sure == 2)
{
    ...
    admin_log ($db, LOG_ADMIN_HARAKIRI, "$playerinfo[character_name]|$ip");
    player_log ($db, $playerinfo['ship_id'], LOG_HARAKIRI, "$ip");
