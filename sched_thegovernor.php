...
// Checking Fighters
    ...
    {
      echo "'-> <span style='color:#FF0000;'>Detected Fighters Overload on Ship: {$playerinfo['ship_id']}.</span> <span style='color:#00FF00;'>*** FIXED ***</span><br />\n";
    ...
    {
      echo "'-> <span style='color:#FF0000;'>Detected Fighters Flip on Ship: {$playerinfo['ship_id']}.</span> <span style='color:#00FF00;'>*** FIXED ***</span><br />\n";
...
// Checking Torpedoes
    ...
    {
      echo "'-> <span style='color:#FF0000;'>Detected Torpedoes Overload on Ship: {$playerinfo['ship_id']}.</span> <span style='color:#00FF00;'>*** FIXED ***</span><br />\n";
    ...
    {
      echo "'-> <span style='color:#FF0000;'>Detected Torpedoes Flip on Ship: {$playerinfo['ship_id']}.</span> <span style='color:#00FF00;'>*** FIXED ***</span><br />\n";
...
// Checking Armor Points
    ...
    {
      echo "'-> <span style='color:#FF0000;'>Detected Armour points Overload on Ship: {$playerinfo['ship_id']}.</span> <span style='color:#00FF00;'>*** FIXED ***</span><br />\n";
    ...
    {
      echo "'-> <span style='color:#FF0000;'>Detected Armour points Flip on Ship: {$playerinfo['ship_id']}.</span> <span style='color:#00FF00;'>*** FIXED ***</span><br />\n";
...
// Checking Credits
    ...
    {
      echo "'-> <span style='color:#FF0000;'>Detected Credits Flip on Ship: {$playerinfo['ship_id']}.</span> <span style='color:#00FF00;'>*** FIXED ***</span><br />\n";
...
// Checking Credits
    ...
    {
      echo "'-> <span style='color:#FF0000;'>Detected Credits Flip on Planet: {$planetinfo['planet_id']}.</span> <span style='color:#00FF00;'>*** FIXED ***</span><br />\n";
    ...
    {
      echo "'-> <span style='color:#FF0000;'>Detected Credits Overflow on Planet: {$planetinfo['planet_id']}.</span> <span style='color:#00FF00;'>*** FIXED ***</span><br />\n";
...
// Checking Fighters
    ...
    {
      echo "'-> <span style='color:#FF0000;'>Detected Fighters Flip on Planet: {$planetinfo['planet_id']}.</span> <span style='color:#00FF00;'>*** FIXED ***</span><br />\n";
...
// Checking Torpedoes
    ...
    {
      echo "'-> <span style='color:#FF0000;'>Detected Torpedoes Flip on Planet: {$planetinfo['planet_id']}.</span> <span style='color:#00FF00;'>*** FIXED ***</span><br />\n";
...
// Checking IGB Balance Credits
    ...
    {
      echo "'-> <span style='color:#FF0000;'>Detected Balance Credits Flip on IGB Account: {$bankinfo['ship_id']}.</span> <span style='color:#00FF00;'>*** FIXED ***</span><br />\n";
...
// Checking IGB Loan Credits
    if($bankinfo['loan'] < 0)
    {
      echo "'-> <span style='color:#FF0000;'>Detected Loan Credits Flip on IGB Account: {$bankinfo['ship_id']}.</span> <span style='color:#00FF00;'>*** FIXED ***</span><br />\n";
...
// Checking IGB Transfer Amount Credits
    ...
    {
      echo "'-> <span style='color:#FF0000;'>Detected Transfer Amount Credits Flip on IGB Transfer: {$transferinfo['ship_id']}.</span> <span style='color:#00FF00;'>*** FIXED ***</span><br />\n";
