...
$variables['first_news_results']['result'] = BntDb::logDbErrors ($db, $resxx, __LINE__, __FILE__);
$local_table_timer->stop ();
...
$variables['ibank_results']['result'] = BntDb::logDbErrors ($db, $update, __LINE__, __FILE__);
$local_table_timer->stop ();
