    ...
    else
    {
        ...
        elseif ($module == "xenobeedit")
        {
            ...
            else
            {
                if (empty ($operation))
                {
                    ...
                    DbOp::dbResult ($db, $logres, __LINE__, __FILE__);
                    while (!$logres->EOF)
                    {
        ...
        elseif ($module == "createnew")
        {
            ...
            if (empty ($operation))
            {
                ...
                DbOp::dbResult ($db, $resultnm, __LINE__, __FILE__);
            ...
            elseif ($operation == "createxenobe")
            {
                ...
                if ($errflag == 0)
                {
                    ...
                    $maxenergy = CalcLevels::Energy ($xenlevel, $level_factor);
                    $maxarmor = CalcLevels::Armor ($xenlevel, $level_factor);
                    $maxfighters = CalcLevels::Fighters ($xenlevel, $level_factor);
                    $maxtorps = CalcLevels::Torpedoes ($xenlevel, $level_factor);
