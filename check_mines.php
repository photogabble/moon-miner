...
if ($num_defences > 0 && $total_sector_mines > 0 && !$owner && $shipavg > $mine_hullsize)
{
    ...
    if ($mine_owner['team'] != $playerinfo['team'] || $playerinfo['team'] == 0 )
    {
        ...
        player_log ($db, $playerinfo['ship_id'], LOG_HIT_MINES, "$roll|$sector");
        ...
        bnt_sector_defense::message_defense_owner ($db, $sector, $l_chm_hehitminesinsector);
        ...
        else
        {
            ...
            else
            {
                ...
                else
                {
                    ...
                    player_log ($db, $playerinfo['ship_id'], LOG_SHIP_DESTROYED_MINES, "$sector|$pod");
                    ...
                    bnt_sector_defense::message_defense_owner ($db, $sector, $l_chm_hewasdestroyedbyyourmines);
