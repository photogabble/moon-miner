...
class BadIbank
{
    public static function ibankBorrow($db, $langvars, $playerinfo, $active_template)
    {
        ...
        if (($amount * 1) != $amount)
        {
            BadIbank::ibankError ($active_template, $langvars, $langvars['l_ibank_invalidamount'], "igb.php?command=loans");
        }
        ...
        if ($account['loan'] != 0)
        {
            BadIbank::ibankError ($active_template, $langvars, $langvars['l_ibank_notwoloans'], "igb.php?command=loans");
        }
        ...
        if ($amount > $maxtrans)
        {
            BadIbank::ibankError ($active_template, $langvars, $langvars['l_ibank_loantoobig'], "igb.php?command=loans");
        }
    ...
    public static function ibankWithdraw2($db, $langvars, $playerinfo)
    {
        ...
        if (($amount * 1) != $amount)
        {
            BadIbank::ibankError ($active_template, $langvars, $langvars['l_ibank_invalidwithdrawinput'], "igb.php?command=withdraw");
        }

        if ($amount == 0)
        {
            BadIbank::ibankError ($active_template, $langvars, $langvars['l_ibank_nozeroamount3'], "igb.php?command=withdraw");
        }

        if ($amount > $account['balance'])
        {
            BadIbank::ibankError ($active_template, $langvars, $langvars['l_ibank_notenoughcredits'], "igb.php?command=withdraw");
        }
    ...
    public static function ibankRepay($db, $langvars, $playerinfo)
    {
        ...
        if ($account['loan'] == 0)
        {
            BadIbank::ibankError ($active_template, $langvars, $langvars['l_ibank_notrepay'], "igb.php?command=loans");
        }
        ...
        {
            BadIbank::ibankError ($active_template, $langvars, $langvars['l_ibank_notenoughrepay'], "igb.php?command=loans");
        }
    ...
    public static function ibankTransfer2($db, $langvars)
    {
        ...
        if (isset ($ship_id)) // Ship transfer
        {
            ...
            {
                BadIbank::ibankError ($active_template, $langvars, $langvars['l_ibank_sendyourself'], "igb.php?command=transfer");
            }

            if (!$res instanceof ADORecordSet || $res->EOF)
            {
                BadIbank::ibankError ($active_template, $langvars, $langvars['l_ibank_unknowntargetship'], "igb.php?command=transfer");
            }
            ...
            if ($target['turns_used'] < $ibank_min_turns)
            {
                ...
                BadIbank::ibankError ($active_template, $langvars, $langvars['l_ibank_min_turns'], "igb.php?command=transfer");
            }
            ...
            if ($playerinfo['turns_used'] < $ibank_min_turns)
            {
                ...
                BadIbank::ibankError ($active_template, $langvars, $langvars['l_ibank_min_turns2'], "igb.php?command=transfer");
            }
            ...
            if ($ibank_trate > 0)
            {
                ...
                if (!$res->EOF)
                {
                    ...
                    BadIbank::ibankError ($active_template, $langvars, $langvars['l_ibank_mustwait'], "igb.php?command=transfer");
                }
            }
        ...
        else
        {
            ...
            {
                BadIbank::ibankError ($active_template, $langvars, $langvars['l_ibank_errplanetsrcanddest'], "igb.php?command=transfer");
            }
            ...
            if (!$res || $res->EOF)
            {
                BadIbank::ibankError ($active_template, $langvars, $langvars['l_ibank_errunknownplanet'], "igb.php?command=transfer");
            }
            ...
            if ($dest['base'] == 'N')
            {
                BadIbank::ibankError ($active_template, $langvars, $langvars['l_ibank_errnobase'], "igb.php?command=transfer");
            }

            if ($source['owner'] != $playerinfo['ship_id'] || $dest['owner'] != $playerinfo['ship_id'])
            {
                BadIbank::ibankError ($active_template, $langvars, $langvars['l_ibank_errnotyourplanet'], "igb.php?command=transfer");
            }
    ...
    public static function ibankTransfer3($db, $langvars)
    {
        ...
        if (isset ($ship_id)) //ship transfer
        {
            ...
            if ($playerinfo['ship_id'] == $ship_id)
            {
                BadIbank::ibankError ($active_template, $langvars, $langvars['l_ibank_errsendyourself'], "igb.php?command=transfer");
            }
            ...
            if ($target['turns_used'] < $ibank_min_turns)
            {
                ...
                BadIbank::ibankError ($active_template, $langvars, $langvars['l_ibank_min_turns3'], "igb.php?command=transfer");
            }

            if ($playerinfo['turns_used'] < $ibank_min_turns)
            {
                $langvars['l_ibank_min_turns4'] = str_replace ("[ibank_min_turns]", $ibank_min_turns, $langvars['l_ibank_min_turns4']);
                BadIbank::ibankError ($active_template, $langvars, $langvars['l_ibank_min_turns4'], "igb.php?command=transfer");
            }
            ...
            if ($ibank_trate > 0)
            {
                ...
                if (!$res->EOF)
                {
                    ...
                    BadIbank::ibankError ($active_template, $langvars, $langvars['l_ibank_mustwait2'], "igb.php?command=transfer");
                }
            }

            if (($amount * 1) != $amount)
            {
                BadIbank::ibankError ($active_template, $langvars, $langvars['l_ibank_invalidtransferinput'], "igb.php?command=transfer");
            }

            if ($amount == 0)
            {
                BadIbank::ibankError ($active_template, $langvars, $langvars['l_ibank_nozeroamount'], "igb.php?command=transfer");
            }

            if ($amount > $account['balance'])
            {
                BadIbank::ibankError ($active_template, $langvars, $langvars['l_ibank_notenoughcredits'], "igb.php?command=transfer");
            }
            ...
            if ($ibank_svalue != 0)
            {
                ...
                if ($amount > $maxtrans)
                {
                    BadIbank::ibankError ($active_template, $langvars, $langvars['l_ibank_amounttoogreat'], "igb.php?command=transfer");
                }
            }
        ...
        else
        {
            ...
            {
                BadIbank::ibankError ($active_template, $langvars, $langvars['l_ibank_notenoughcredits2'], "igb.php?command=transfer");
            }
    ...
    public static function ibankDeposit2($db, $langvars, $playerinfo)
    {
        ...
        if (($amount * 1) != $amount)
        {
            BadIbank::ibankError ($active_template, $langvars, $langvars['l_ibank_invaliddepositinput'], "igb.php?command=deposit");
        }

        if ($amount == 0)
        {
            BadIbank::ibankError ($active_template, $langvars, $langvars['l_ibank_nozeroamount2'], "igb.php?command=deposit");
        }

        if ($amount > $playerinfo['credits'])
        {
            BadIbank::ibankError ($active_template, $langvars, $langvars['l_ibank_notenoughcredits'], "igb.php?command=deposit");
        }
        ...
        {
            BadIbank::ibankError ($active_template, $langvars, "<center>Error You cannot deposit that much into your bank,<br> (Max Credits Reached)</center>", "igb.php?command=deposit");
        }
    ...
    public static function ibankConsolidate3($db, $langvars, $playerinfo)
    {
        ...
        if (!$res || $res->EOF)
        {
            BadIbank::ibankError ($active_template, $active_template, $langvars, $langvars['l_ibank_errunknownplanet'], "igb.php?command=transfer");
        }
        ...
        if ($dest['owner'] != $playerinfo['ship_id'])
        {
            BadIbank::ibankError ($active_template, $active_template, $langvars, $langvars['l_ibank_errnotyourplanet'], "igb.php?command=transfer");
        }
        ...
        {
            BadIbank::ibankError ($active_template, $active_template, $langvars, $langvars['l_ibank_notenturns'], "igb.php?command=transfer");
        }
