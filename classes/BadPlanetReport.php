...
//
// File: classes/BadPlanetReport.php
//
...
if (strpos ($_SERVER['PHP_SELF'], 'BadPlanetReport.php')) // Prevent direct access to this file
{
    $error_file = $_SERVER['SCRIPT_NAME'];
    include_once './error.php';
}

class BadPlanetReport
{
    ...
    public static function sellingCheckboxes($planet, $i)
    {
        if ($planet[$i]['sells'] != 'Y')
        {
