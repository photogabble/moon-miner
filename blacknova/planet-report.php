...
{
echo "<BR>";
echo "<B><A HREF=alliance-planets.php>$l_pr_teamlink</A></B>";
echo "<BR>";
echo "<BR>";
}
...
else
{
  ...
  echo "<TD><B><A HREF=planet-report.php?sort=sector_id>$l_sector</A></B></TD>";
  echo "<TD><B><A HREF=planet-report.php?sort=name>$l_name</A></B></TD>";
  echo "<TD><B><A HREF=planet-report.php?sort=ore>$l_ore</A></B></TD>";
  echo "<TD><B><A HREF=planet-report.php?sort=organics>$l_organics</A></B></TD>";
  echo "<TD><B><A HREF=planet-report.php?sort=goods>$l_goods</A></B></TD>";
  echo "<TD><B><A HREF=planet-report.php?sort=energy>$l_energy</A></B></TD>";
  echo "<TD><B><A HREF=planet-report.php?sort=colonists>$l_colonists</A></B></TD>";
  echo "<TD><B><A HREF=planet-report.php?sort=credits>$l_credits</A></B></TD>";
  echo "<TD><B><A HREF=planet-report.php?sort=fighters>$l_fighters</A></B></TD>";
  echo "<TD><B><A HREF=planet-report.php?sort=torp>$l_torps</A></B></TD>";
