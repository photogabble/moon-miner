<?
	...
	{	
		...
		if (empty($command))
		{
			...
			if ($command=="sell")
			{
				...
				/* build a base */
				if ($sectorinfo[planet_ore]>=$base_ore && $sectorinfo[planet_organics]>=$base_organics && $sectorinfo[planet_goods]>=$base_goods && $sectorinfo[planet_credits]>=$base_credits)
				{
			...
			if ($command=="buy")
			{
				...
				if ($onplanet[on_planet]=='N' or empty($onplanet[on_planet]))
				{
					...
					if ($sectorinfo[base]=="Y") {$ownerinfo[beams]=$ownerinfo[beams]+$base_modifier;}
					...
					if ($sectorinfo[base]=="Y") {$ownerinfo[shields]=$ownerinfo[shields]+$base_modifier;}
					...
					if ($playertorpnum>$playerinfo[torps]){$playertorpnum=$playerinfo[torps];}
					if ($sectorinfo[base]=="Y") {$ownerinfo[torp_launchers]=$ownerinfo[torp_launchers]+$base_modifier;}
					$planettorpnum=(pow($level_factor,$ownerinfo[torp_launchers]))*2;
					if ($planettorpnum>$sectorinfo[base_torp]){$planettorpnum=$sectorinfo[base_torp];}
					...
					{
						if ($playertorpdmg>$planetfighters) {$playertorpdmg=$planetfighters;}
						$planetfighters=$planetfighters-$playertorpdmg;
					...
					if ($ownertorpnum>$ownerinfo[torps]){$ownertorpnum=$ownerinfo[torps];}
				...
				if ($roll>$success)
				{
					...
					echo "Sensors cannot get a fix on target!<BR><BR>Click <a href=main.php3>here</a> to return to Main Menu.";
					...
					$roll=rand(1,100);
					if ($roll<$success)	{echo "<td>$sectorinfo[planet_organics]</td></tr>";} else {echo "<td>???</td></tr>";}
					echo "<tr><td>Ore:</td>";
					$roll=rand(1,100);
					if ($roll<$success)	{echo "<td>$sectorinfo[planet_ore]</td></tr>";} else {echo "<td>???</td></tr>";}
					echo "<tr><td>Goods:</td>";
					$roll=rand(1,100);
					if ($roll<$success)	{echo "<td>$sectorinfo[planet_goods]</td></tr>";} else {echo "<td>???</td></tr>";}
					echo "<tr><td>Energy:</td>";
					$roll=rand(1,100);
					if ($roll<$success)	{echo "<td>$sectorinfo[planet_energy]</td></tr>";} else {echo "<td>???</td></tr>";}
					echo "<tr><td>Colonists:</td>";
					$roll=rand(1,100);
					if ($roll<$success)	{echo "<td>$sectorinfo[planet_colonists]</td></tr>";} else {echo "<td>???</td></tr>";}
					echo "<tr><td>Credits:</td>";
					$roll=rand(1,100);
					if ($roll<$success)	{echo "<td>$sectorinfo[planet_credits]</td></tr>";} else {echo "<td>???</td></tr>";}
					echo "<tr><td>Defenses:</td><td></td>";
					echo "<tr><td>Base:</td>";
					$roll=rand(1,100);
					if ($roll<$success)	{echo "<td>$sectorinfo[base]</td></tr>";} else {echo "<td>???</td></tr>";}
					echo "<tr><td>Base Torpedoes:</td>";
					$roll=rand(1,100);
					if ($roll<$success)	{echo "<td>$sectorinfo[base_torp]</td></tr>";} else {echo "<td>???</td></tr>";}
					echo "<tr><td>Fighters:</td>";
					$roll=rand(1,100);
					if ($roll<$success)	{echo "<td>$sectorinfo[planet_fighters]</td></tr>";} else {echo "<td>???</td></tr>";}
					echo "<tr><td>Beams:</td>";
					$roll=rand(1,100);
					if ($roll<$success)	{echo "<td>$ownerinfo[beams]</td></tr>";} else {echo "<td>???</td></tr>";}
					echo "<tr><td>Torpedo Launchers:</td>";
					$roll=rand(1,100);
					if ($roll<$success)	{echo "<td>$ownerinfo[torp_launchers]</td></tr>";} else {echo "<td>???</td></tr>";}
					echo "<tr><td>Shields</td>";
					$roll=rand(1,100);
					if ($roll<$success)	{echo "<td>$ownerinfo[shields]</td></tr>";} else {echo "<td>???</td></tr>";}
					echo "</table><BR>";
					$roll=rand(1,100);
					if ($ownerinfo[sector]==$playerinfo[sector] && $ownerinfo[on_planet]=='Y' && $roll<$success) { echo "$ownerinfo[character_name] is on the planet.<BR><BR>";}
				}
	...
	if ($command!="") { echo "<BR>Click <a href=planet.php3>here</a> to return to planet menu.<BR>"; }
	echo "<BR>Click <a href=main.php3>here</a> to return to Main Menu.";
