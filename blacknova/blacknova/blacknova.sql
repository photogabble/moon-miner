...
CREATE TABLE ships (
   ...
   tech_hull bigint(20) unsigned DEFAULT '0' NOT NULL,
   tech_engines bigint(20) unsigned DEFAULT '0' NOT NULL,
   tech_power bigint(20) unsigned DEFAULT '0' NOT NULL,
   tech_computer bigint(20) unsigned DEFAULT '0' NOT NULL,
   tech_sensors bigint(20) unsigned DEFAULT '0' NOT NULL,
   tech_beams bigint(20) unsigned DEFAULT '0' NOT NULL,
   tech_torps bigint(20) unsigned DEFAULT '0' NOT NULL,
   tech_armour bigint(20) unsigned DEFAULT '0' NOT NULL,
   tech_cloak bigint(20) unsigned DEFAULT '0' NOT NULL,
   tech_shields bigint(20) unsigned DEFAULT '0' NOT NULL,
