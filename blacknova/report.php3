...
echo "<TR BGCOLOR=\"$color_line2\"><TD>$l_power</TD><TD>$l_level $playerinfo[computer]</TD></TR>";
...
echo "<TR><TD>&nbsp;</TD></TR>";
$armour_pts_max = NUM_ARMOUR($playerinfo[armour]);
...
echo "<TR BGCOLOR=\"$color_line1\"><TD>$l_armourpts</TD><TD ALIGN=RIGHT>" . NUMBER($playerinfo[armour_pts]) . " / " . NUMBER($armour_pts_max) . "</TD></TR>";
