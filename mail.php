...
if(!$result->EOF)
{
    ...
    if($_SESSION['sendemail'] == false)
    {
        ...
        echo "<table style='width:500px; border:#fff 1px solid; color:#000000;'>\n";
        echo "  <tr>\n";
        echo "    <td style='background-color:#C0C0C0; border:#fff 1px solid; text-align:center; font-size:14px; color:#000000;' colspan='2'>Sending Email Request</td>\n";
        echo "  </tr>\n";
        echo "  <tr>\n";
        ...
        echo "  </tr>\n";
        echo "  <tr>\n";
        echo "    <td colspan='2' style='background-color:#C0C0C0; border:#fff 1px solid; font-size:10px; color:#000000;'>{$mailerInfo}</td>\n";
        echo "  </tr>\n";
        echo "</table>\n";
        echo "</div>\n";
        sleep(1);
    ...
    else
    {
        ...
        echo "  <tr>\n";
        echo "    <td style='background-color:#C0C0C0; border:#fff 1px solid; text-align:center; font-size:14px; color:#000000;' colspan='2'>Send Email Request</td>\n";
        echo "  </tr>\n";
        echo "  <tr>\n";
        echo "    <td style='background-color:#C0C0C0; border:#fff 1px solid; padding:8px; width:100px; margin:auto; text-align:center;'><img style='width:64px; height:64px; margin:auto; border:none;' src='{$image}' /></td>\n";
        echo "    <td style='background-color:{$colors[0]}; border:{$colors[1]} 1px solid; color:#fff; width:400px; text-align:left; font-size:14px; padding:6px;'>{$result}</td>\n";
        echo "  </tr>\n";
        echo "  <tr>\n";
        echo "    <td colspan='2' style='background-color:#C0C0C0; border:#fff 1px solid; font-size:10px; color:#000000;'>{$mailerInfo}</td>\n";
        echo "  </tr>\n";
