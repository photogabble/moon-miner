...
//
// File: classic_set_config.ini.php
...
// True / False items are 1/0 respectively
...
[OPTIONAL_FEATURES]
allow_fullscan             = 1;                                // Allow players to use full long range scan during this game?
allow_navcomp              = 1;                                // Allow players to use the Navigation computer during this game?
allow_ibank                = 1;                                // Allow players to use the Intergalactic Bank IGB during this game?
...
footer_show_debug          = 1;                                // Should the footer show the memory and time to generate page?
sched_planet_valid_credits = 1;                                // Limit captured planets Max Credits to max_credits_without_base
...
bounty_all_special         = 1;                                // Stop access on all Special Ports when you have a federation bounty on you.
