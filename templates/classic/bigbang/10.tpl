...
<table border="0" cellpadding="1" width="700" cellspacing="1" bgcolor="#000000">
    ...
    <tr>
      ...
      <td width="100" bgcolor="#C0C0C0"><font size="1" color="#000000"><input type=text name=sektors size=10 maxlength=10 value=1000></font></td>
    </tr>
    <tr>
    ...
    <tr>
      <td width="700" colspan="2" bgcolor="#C0C0C0" align="left"><font color="#000000" size="1"><p align='center'><input type=submit value={$langvars['l_submit']}><input type=reset value={$langvars['l_reset']}></p></font></td>
    </tr>
    <tr>
      <td width="100%" colspan="2" bgcolor="#9999cc" align="left"><font color="#000000" size="1"> </font></td>
    </tr>
