...
<table style="border:0px; border-spacing:0px; font-size:100%; line-height:1.125em;">
  ...
  <tr>
    <td style="font-color:#fff"><strong>This version of setup info has been written for BNT v0.70</strong></td>
  </tr>
</table>
</div><br>
<br>
<p style="font-size:0.875em; font-color:#ffff00">
<i>This page is intended to help resolve problems in setting up Blacknova Traders.</i><br>
<i>It contains diagnostic information to help you diagnose any issues.</i></p>
<p style="font-size:0.875em; font-color:#fff">To display all errors, create a file named "dev" in your BNT directory.<br>
If you get any errors or incorrect info returned then save as html and email it to <a class="email" href="mailto:TheMightyDude@gmail.com">TheMightyDude</a><br>
