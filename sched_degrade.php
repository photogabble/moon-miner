...
while (!$res->EOF)
{
    ...
    BntDb::logDbErrors ($db, $res3, __LINE__, __FILE__);
    ...
    if ($res2->EOF)
    {
        ...
        BntPlayerLog::writeLog ($db, $row['ship_id'], LOG_DEFENCE_DEGRADE, $row['sector_id'] ."|". $degrade_rate);
    }
    else
    {
        ...
        BntDb::logDbErrors ($db, $res4, __LINE__, __FILE__);
